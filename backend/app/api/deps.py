...
ROLE_MODULES = {
    ...
    "designer": {"design"},
    "planner": {"overview", "commercial", "design", "production", "corte", "confection", "subcontracting", "shipping", "warehouse", "erp", "tables", "dyeing", "printing", "weaving", "spinning", "laundry", "embroidery", "finishing"},
    ...
    "quality": {"production"},
    "warehouse": {"warehouse", "shipping", "erp", "tables"},
...
RESOURCE_MODULES = {
    ...
    "samples": {"design"}, "developments": {"design"}, "certifications": {"design"}, "materials": {"design", "commercial", "shipping", "erp", "tables", "warehouse"},
    ...
    "stock-lots": {"shipping", "production", "erp", "warehouse"}, "inventory-movements": {"shipping", "production", "warehouse"},
    "purchase-orders": {"shipping", "erp", "warehouse"}, "purchase-order-lines": {"shipping", "erp", "warehouse"}, "shipments": {"shipping"},
    "warehouses": {"shipping", "erp", "management", "tables", "warehouse"}, "payment-terms": {"commercial", "erp", "management", "tables"},
