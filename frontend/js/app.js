...
import * as styles from './pages/styles.js?v=20260827-1';
import * as samples from './pages/samples.js?v=20260826-3';
import * as costing from './pages/costing.js?v=20260827-8';
...
import * as tables from './pages/tables.js?v=20260827-1';
