...
export const MODULES = [
  ...
  },
  {
    ...
    routes:[
      ...
      ['confection-days','Capacidade diária','◧','config'],
      ['confection-events','Ausências e ajustes','◪','config'],
      ['confection-external','Capacidade externa','⇄','config'],
      ['confection-execution','Execução real','▣','config'],
    ],
